...
# ── WooCommerce Stripe Sites (للبوابات الجديدة) ──
WOOCOMMERCE_SITE_PASSED = os.environ.get("WOOCOMMERCE_SITE_PASSED", "https://www.warmisland.com")
WOOCOMMERCE_SITE_OTP = os.environ.get("WOOCOMMERCE_SITE_OTP", "https://www.warmisland.com")
